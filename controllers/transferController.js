const { validateTransferSchema, validateTransfer, transferMoney, getAllTransfers, validateId, getTransferById, getTransferByAccountNum } = require("../services/transfersService");
...
const newTransfer = async(req, res, next) => {
  try {
    ...
    validateTransferSchema(Number(accountNumber), destinationAccount, value);
    await validateTransfer(Number(accountNumber), destinationAccount, value);
